...
void init_21cmMC_arrays() { // defined in Cosmo_c_files/ps.c
    ...
    Overdense_spline_SFRPOP2PARK = calloc(NSFR_high,sizeof(float)); //-GS
    ...
    Fcoll_spline_SFRPOP2PARK = calloc(NSFR_high,sizeof(float)); //-GS
    ...
    second_derivs_SFRPOP2PARK = calloc(NSFR_high,sizeof(float)); //-GS
...
void destroy_21cmMC_arrays() {
    ...
    free(Overdense_spline_SFRPOP2PARK); //-GS
    ...
    free(Fcoll_spline_SFRPOP2PARK); //-GS
    ...
    free(second_derivs_SFRPOP2PARK); //-GS
...
int main(int argc, char ** argv){
  ...
  float Splined_SFRD_PARK; // -GS
  float Splined_RHOL_HI1216A, Splined_RHOL_HI6563A, Splined_RHOL_HI4861A, Splined_RHOL_CII158m, Splined_RHOL_CO2600m, Splined_RHOL_OIII88m;
  double mean_sfrd_st, ST_over_PS_SFRD, sfrd; // scalar set for SFRD -GS
  double mean_sfrd_park_st, ST_over_PS_SFRD_PARK, sfrd_park; // scalar set for SFRD (PARK) -GS
  ...
  double mean_rhol_st_CII158m, ST_over_PS_CII158m, rhol_cii158m; // scalar set for CII 158um luminosity density -GS
  double mean_rhol_st_CO2600m, ST_over_PS_CO2600m, rhol_co2600m; // scalar set for CO(1-0) luminosity density -GS
  double mean_rhol_st_OIII88m, ST_over_PS_OIII88m, rhol_oiii88m; // scalar set for OIII 88um luminosity density -GS
  // - RM
  float Splined_zeta;
  ...
  *error_message = '\0';
  ...
  float lya_table_pop2[DIM_POP2_METALLICITY][DIM_POP2_ION_PARAM],
        ...
        o3fir_table_pop2[DIM_POP2_METALLICITY][DIM_POP2_ION_PARAM];
  ...
  init_pop2_full_tables(lya_table_pop2, ha_table_pop2, hb_table_pop2, he2_table_pop2,
                        o3_table_pop2, o2s_table_pop2, o2l_table_pop2, c2_table_pop2, co10_table_pop2, o3fir_table_pop2);
...
/*  if ((fabs(ALPHA_STAR) > FRACT_FLOAT_ERR) ||
  ...
  SFRD_PARK = (float *) malloc(sizeof(float)*HII_TOT_FFT_NUM_PIXELS);
  sfrd_box = (float *) malloc(sizeof(float)*HII_TOT_FFT_NUM_PIXELS);
  sfrd_park_box = (float *) malloc(sizeof(float)*HII_TOT_FFT_NUM_PIXELS);
  ...
  RHOL_OIII88m = (float *) malloc(sizeof(float)*HII_TOT_FFT_NUM_PIXELS);
  ...
  I_OIII88m_box = (float *) malloc(sizeof(float)*HII_TOT_FFT_NUM_PIXELS);
 ...
 // }
  ...
  mean_sfrd_park_st = FgtrM_st_SFRPOP2PARK(REDSHIFT, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar);
  mean_rhol_st_HI1216A = FgtrM_st_LINELUMPOP2A(REDSHIFT, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 0);
  mean_rhol_st_HI6563A = FgtrM_st_LINELUMPOP2B(REDSHIFT, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 1);
  mean_rhol_st_CII158m = FgtrM_st_LINELUMPOP2C(REDSHIFT, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 7);
  mean_rhol_st_CO2600m = FgtrM_st_LINELUMPOP2D(REDSHIFT, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 8);
  mean_rhol_st_OIII88m = FgtrM_st_LINELUMPOP2E(REDSHIFT, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 9);
  mean_rhol_st_HI4861A = FgtrM_st_LINELUMPOP2F(REDSHIFT, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 2);
 ...
 CLEANUP: if (*error_message != '\0'){
    ...
    initialiseFcollSFRPOP2PARK_spline(REDSHIFT, massofscaleR, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar);
    initialiseFcollLINELUMPOP2A_spline(REDSHIFT, massofscaleR, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 0);
    initialiseFcollLINELUMPOP2B_spline(REDSHIFT, massofscaleR, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 1);
    initialiseFcollLINELUMPOP2C_spline(REDSHIFT, massofscaleR, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 7);
    initialiseFcollLINELUMPOP2D_spline(REDSHIFT, massofscaleR, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 8);
    initialiseFcollLINELUMPOP2E_spline(REDSHIFT, massofscaleR, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 9);
    initialiseFcollLINELUMPOP2F_spline(REDSHIFT, massofscaleR, M_TURN, ALPHA_STAR, F_STAR10, Mlim_Fstar, 2);
    // - RM
    /*
    if(USE_GENERAL_SOURCES)
    {
    ...
    if(USE_GENERAL_SOURCES)
    {
      ...
      Splined_Fcoll_uni = splined_erfc(erfc_num/erfc_denom);
        ...
        FcollSpline_SFRPOP2PARK(density_over_mean - 1, &(Splined_SFRD_PARK));
        FcollSpline_LINELUMPOP2A(density_over_mean - 1, &(Splined_RHOL_HI1216A));
        FcollSpline_LINELUMPOP2B(density_over_mean - 1, &(Splined_RHOL_HI6563A));
        FcollSpline_LINELUMPOP2C(density_over_mean - 1, &(Splined_RHOL_CII158m));
        FcollSpline_LINELUMPOP2D(density_over_mean - 1, &(Splined_RHOL_CO2600m));
        FcollSpline_LINELUMPOP2E(density_over_mean - 1, &(Splined_RHOL_OIII88m));
        FcollSpline_LINELUMPOP2F(density_over_mean - 1, &(Splined_RHOL_HI4861A));
        }
      ...
      Splined_Fcoll_uni = 1.0;
        ...
        SFRD_PARK[HII_R_FFT_INDEX(x,y,z)] = Splined_SFRD_PARK * (OMm*RHOcrit);
        ...
        RHOL_OIII88m[HII_R_FFT_INDEX(x,y,z)] = Splined_RHOL_OIII88m * (OMm*RHOcrit);
	      f_coll += Splined_Fcoll;
        sfrd += Splined_SFRD;
        sfrd_park += Splined_SFRD_PARK;
        ...
        rhol_oiii88m += Splined_RHOL_OIII88m;
        // - RM
        /*
        if(USE_GENERAL_SOURCES)
        {
  ...
  sfrd_park /= (double) HII_TOT_NUM_PIXELS; // ave PS fcoll for this filter scale
  ...
  rhol_oiii88m /= (double) HII_TOT_NUM_PIXELS;
  ...
  ST_over_PS_SFRD_PARK = mean_sfrd_park_st / sfrd_park;
  ...
  ST_over_PS_OIII88m = mean_rhol_st_OIII88m / rhol_oiii88m;
    ...
    for (x=0; x<HII_DIM; x++){
      for (y=0; y<HII_DIM; y++){
        for (z=0; z<HII_DIM; z++){
          ...
          sfrd_park_box[ct] = SFRD_PARK[ct] * ST_over_PS_SFRD_PARK; // get normalized SFRD -GS
          ...
          I_OIII88m_box[ct] = C * Lsun * RHOL_OIII88m[ct] * ST_over_PS_OIII88m / (4 * PI * OIII88m_HZ * hubble(REDSHIFT) * pow(CMperMPC, 3));
        }
      }
    }
    ...
    sprintf(filename, "../Boxes/SFRD_PARK_z%06.2f_HIIfilter%i_RHIImax%.0f_%i_%.0fMpc", REDSHIFT, HII_FILTER, MFP, HII_DIM, BOX_LEN);
    if (!(F = fopen(filename, "wb"))) {
      sprintf(error_message, "find_HII_bubbles.c: ERROR: unable to open file for writing SFRD (PARK) box.\n");
      goto CLEANUP;
    }
    else {
      for (x = 0; x < HII_DIM; x++) {
        for (y = 0; y < HII_DIM; y++) {
          for (z = 0; z < HII_DIM; z++) {
            if (fwrite(sfrd_park_box + HII_R_FFT_INDEX(x,y,z), sizeof(float), 1, F) != 1) {
               sprintf(error_message, "find_HII_bubbles.c: Write error occured while writing SFRD (PARK) box.\n");
               goto CLEANUP;
            }
          }
        }
    ...
    // OIII88m line intensity box
    sprintf(filename, "../Boxes/I_OIII88m_z%06.2f_HIIfilter%i_RHIImax%.0f_%i_%.0fMpc", REDSHIFT, HII_FILTER, MFP, HII_DIM, BOX_LEN);
    if (!(F = fopen(filename, "wb"))) {
      sprintf(error_message, "find_HII_bubbles.c: ERROR: unable to open file for writing OIII88m line intensity box.\n");
      goto CLEANUP;
    }
    else {
      for (x = 0; x < HII_DIM; x++) {
        for (y = 0; y < HII_DIM; y++) {
          for (z = 0; z < HII_DIM; z++) {
            if (fwrite(I_OIII88m_box + HII_R_FFT_INDEX(x,y,z), sizeof(float), 1, F) != 1) {
               sprintf(error_message, "find_HII_bubbles.c: Write error occured while writing OIII88m line intensity box.\n");
               goto CLEANUP;
            }
          }
        }
